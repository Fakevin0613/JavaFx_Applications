        ...
        if(Model.getViewNumber() == 1){
            ...
            for(nums in 0 until theData.size){
                if(Model.getColor() == 0){
                    ...
                    gc.fill = Color.rgb((150 + 100 * (nums+1)*hgap / width).toInt(),
                        (255 * (nums+1)*hgap / width).toInt(),
                        (150 - 100 * (nums+1)*hgap / width).toInt())
                }
                else if(Model.getColor() == 2){
                    gc.fill = Color.rgb((150 * (nums+1)*hgap / width).toInt(),
                        (255 - 255 * (nums+1)*hgap / width).toInt(),
                        (150 * (nums+1)*hgap / width).toInt())
                }
                if(theData[nums] > 0.0){
            ...
            gc.globalAlpha = 0.5
            gc.fill = Color.WHITE
            gc.fillRect(0.0, 0.0, 120.0, 70.0)
            gc.globalAlpha = 1.0
            ...
            if(Model.getHasNegative()){
                ...
                gc.globalAlpha = 0.5
                gc.fill = Color.WHITE
                gc.fillRect(0.0, 0.0, 120.0, 100.0)
                gc.globalAlpha = 1.0
                ...
                gc.fillText("mean: " + String.format("%.2g%n", mean), 20.0, 20.0, 200.0)
                gc.fillText("SEM: " + String.format("%.2g%n", sem), 20.0, 50.0, 200.0)
                gc.fillText("SD: " + String.format("%.2g%n", sd), 20.0, 80.0, 200.0)
            }
        }
